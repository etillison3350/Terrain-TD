...
public class Gun {
	...
	public Gun(ProjectileType[] projectiles, double x, double y) {
	 ...
	 * @throws IllegalArgumentException if e is not a tower or enemy, or if its list of projectiles is <code>null</code> or
	 *         empty.
	 *         </ul>
	 */
	public Gun(Entity e) {
	...
	public double getRotation() {
		return Math.atan2(this.y - target.getY(), this.x - target.getX());
	}
